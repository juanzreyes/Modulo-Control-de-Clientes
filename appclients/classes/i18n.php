 ...
 *
 */
function t( $string, $domain = I18N_DEFAULT_DOMAIN )
{
 ...
 *
 */
function e( $string, $domain = I18N_DEFAULT_DOMAIN )
{
 ...
 *
 */
function n( $singular, $plural, $count, $domain = I18N_DEFAULT_DOMAIN )
{
 ...
 *
 */
function ne( $singular, $plural, $count, $domain = I18N_DEFAULT_DOMAIN )
{
